...
TEST_CASE("different types same NumExpr vals") {
    CHECK((new AddExpr(new NumExpr(2), new NumExpr(24)))->equals(new MultExpr(new NumExpr(2), new NumExpr(24))) ==
          false);
...
TEST_CASE("Branden's tests") {
    MultExpr *complexMultExprWithVar = new MultExpr(
            new AddExpr(new VarExpr("x"), new MultExpr(new NumExpr(2), new NumExpr(3))), new NumExpr(3));
    MultExpr *complexMultExprWithNoVar = new MultExpr(

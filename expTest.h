...
//    CHECK((NEW() AddExpr(NEW() NumExpr(-143), NEW() NumExpr(25)))->equals(NEW() MultExpr(NEW() NumExpr(-143), NEW() NumExpr(25))) ==
//          false);
...
//    MultExpr PTR()complexMultExprWithVar = NEW() MultExpr(
//            NEW() AddExpr(NEW() VarExpr("x"), NEW() MultExpr(NEW() NumExpr(2), NEW() NumExpr(3))), NEW() NumExpr(3));
//    MultExpr PTR()complexMultExprWithNoVar = NEW() MultExpr(
...
//                        NEW() MultExpr(NEW() NumExpr(3), NEW() NumExpr(4))))->pretty_print_to_string() == "(1 * 2) * 3 * 4");
//    CHECK((NEW() MultExpr(NEW() NumExpr(2), NEW() MultExpr(NEW() NumExpr(3), NEW() NumExpr(4))))->pretty_print_to_string() ==
//          "2 * 3 * 4");
...
//    NumExpr PTR()testNum1 = NEW() NumExpr(1);
//    NumExpr PTR()testNum2 = NEW() NumExpr(2);
//    NumExpr PTR()testNum3 = NEW() NumExpr(3);
//    NumExpr PTR()testNum4 = NEW() NumExpr(4);
//
//    VarExpr PTR()testVar1 = NEW() VarExpr("a");
//    VarExpr PTR()testVar2 = NEW() VarExpr("b");
//
//    AddExpr PTR()testAdd1 = NEW() AddExpr(testNum1, testNum2);
//    AddExpr PTR()testAdd2 = NEW() AddExpr(testNum3, testAdd1);
//    AddExpr PTR()testAdd3 = NEW() AddExpr(testAdd1, testNum3);
//    AddExpr PTR()testAdd4 = NEW() AddExpr(testNum3, testNum4);
//    AddExpr PTR()testAdd5 = NEW() AddExpr(testAdd1, testAdd4);
//
//    AddExpr PTR()testAdd6 = NEW() AddExpr(testNum1, testVar1);
//
//    MultExpr PTR()testMult1 = NEW() MultExpr(testNum3, testNum4);
//
//    AddExpr PTR()testMixed1 = NEW() AddExpr(testNum1, testMult1);
//
...
//
//    AddExpr PTR()testAdd1 = NEW() AddExpr(testNum1, testNum2);
//    AddExpr PTR()testAdd2 = NEW() AddExpr(testNum3, testNum4);
//
//    MultExpr PTR()testMult1 = NEW() MultExpr(testNum1, testNum2);
//    MultExpr PTR()testMult2 = NEW() MultExpr(testNum3, testMult1);
//    MultExpr PTR()testMult3 = NEW() MultExpr(testMult1, testNum3);
//    MultExpr PTR()testMult4 = NEW() MultExpr(testNum3, testNum4);
//    MultExpr PTR()testMult5 = NEW() MultExpr(testMult1, testMult4);
//
//    std::stringstream out("");
...
//    CHECK(out.str() == "(1 * 2) * 3 * 4");
//
//    MultExpr PTR()testMixed1 = NEW() MultExpr(testNum3, testAdd1);
//    MultExpr PTR()testMixed2 = NEW() MultExpr(testAdd1, testNum3);
//    MultExpr PTR()testMixed3 = NEW() MultExpr(testAdd1, testAdd2);
//
//    out.str("");
//    testMixed1->pretty_print(out);
//    CHECK(out.str() == "3 * (1 + 2)");
...
//                                     NEW() MultExpr(NEW() MultExpr(NEW() NumExpr(10), NEW() NumExpr(10)), NEW() NumExpr(10))),
...
//                                    NEW() LetExpr("x", NEW() NumExpr(5), NEW() MultExpr(NEW() VarExpr("x"), NEW() NumExpr(2)))),
...
//          "          _in  (x + y) * z"
//    );
//    LetExpr PTR()tripleNestedLet4 = NEW() LetExpr("x", NEW() NumExpr(5),
//                                            NEW() LetExpr("y", NEW() NumExpr(3),
//                                                        NEW() AddExpr(NEW() VarExpr("y"), NEW() NumExpr(2))));
//    LetExpr PTR()tripleNestedLet5 = NEW() LetExpr("x", NEW() NumExpr(5),
...
//                                       NEW() LetExpr("z", NEW() AddExpr(NEW() VarExpr("x"), NEW() NumExpr(1)),
//                                                   NEW() MultExpr(NEW() AddExpr(NEW() VarExpr("x"), NEW() VarExpr("y")),
//                                                                NEW() VarExpr("z"))))))->interp()->equals(NEW() numVal(4)));
//        CHECK((NEW() MultExpr((NEW() AddExpr(NEW() MultExpr(NEW() NumExpr(5), NEW() LetExpr("x", NEW() NumExpr(5),
//                                                                                  NEW() MultExpr(NEW() VarExpr("x"),
//                                                                                               NEW() NumExpr(2)))),
...
//    CHECK((NEW() IfExpr(NEW() EqExpr(NEW() NumExpr(4), NEW() NumExpr(4)), NEW() NumExpr(6), NEW() NumExpr(7)))->interp()->equals(
//            NEW() numVal(6)));
//    CHECK((NEW() IfExpr(NEW() EqExpr(NEW() NumExpr(4), NEW() NumExpr(64)), NEW() NumExpr(6), NEW() NumExpr(7)))->interp()->equals(
//            NEW() numVal(7)));
//}
//
//
...
//            NEW() NumExpr(10)))->interp()->equals(NEW() numVal(11)));
//    CHECK((NEW() CallExpr(
//            NEW() FunExpr(("x"), NEW() AddExpr(NEW() VarExpr("x"), NEW() NumExpr(1))),
...
//    // 2
    ...
    shared_ptr<FunVal> fun_val_x_add_x_1 = NEW(FunVal) ("x", add_x_1);
